...
def upgrade() -> None:
    ...
    op.add_column('readers', sa.Column('password', sa.String(255)), schema='my_app_schema')
    ...
    op.alter_column('readers', 'password', nullable=False, schema='my_app_schema')
...
def downgrade() -> None:
    ...
    # op.create_unique_constraint('readers_passport_key', 'readers', ['passport'], schema='my_app_schema')
    op.drop_column('readers', 'password', schema='my_app_schema')
    # ### end Alembic commands ###
